 ...
 * Problema: 1296 - Contest Scoreboard
 ...
 * Con la estructura de pair de la STL se facilita bastante los datos. Estos
 * se ordenan en primera instancia en base al elemento first y luego en base
 * al second. */
